...
When('I select Flat Rate shipping method', async function() {
    this.shippingPrice = await shippingPage.getFlatRatePrice.getText();
...
Then('Correct order information is displayed', async function() {
    ...
    await expect(orderPage.firstProductQty).toHaveText("1");
